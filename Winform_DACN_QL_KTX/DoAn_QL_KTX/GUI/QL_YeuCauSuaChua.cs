...
namespace GUI
{
    public partial class QL_YeuCauSuaChua : Form
    {
        ...
        public QL_YeuCauSuaChua()
        {
            ...
            text_maphong.TextChanged += Text_maphong_TextChanged;
        ...
        private void Btn_Sua_YCSC_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string trangThai = text_QL_TrangThai_YCSC.Text; // Trạng thái sửa chữa
                ...
                // Tạo đối tượng BLL để gọi hàm cập nhật
        ...
        private void Btn_TK_TSSC_Click(object sender, EventArgs e)
        {
            ...
            // Lấy dữ liệu từ BLL
            List<ThongKeSuaChua> thongKeData = bll.GetTanSuatHongHoc(nam, thang);
        ...
        private void DrawPieChart(List<ThongKeSuaChua> thongKeData)
        {
        ...
        private void DataGVQL_DS_YCSC_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                if (ycscDetails != null)
                {
                    ...
                    text_QL_TrangThai_YCSC.Text = ycscDetails.TrangThai;
        ...
        private void Text_maphong_TextChanged(object sender, EventArgs e)
        {
        ...
        private void Btn_ThemYCSC_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                YeuCauSuaChua ycSuaChua = new YeuCauSuaChua
                {
                    ...
                    TrangThai = "Chuẩn bị thực hiện", // Trạng thái yêu cầu sửa chữa
